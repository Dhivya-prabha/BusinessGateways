...
public class CreateReverseAuctionMultipleStandard extends BidProcMethods  {
	...
	void createAndVerifyReverseAuctionMultipleStandard(String pTitle, String aTitle,String desc,String variant,
			String method, String currency,String decPlaces, String location,String multi,
		...
		.ClickSearchButton()
		.verifyReverseEAuctionInList(aTitle+auctionRef);
